...
class TrafficLightInstance extends instance_skel {
	...
	updatePresets() {
		...
		this.setPresetDefinitions([
			...
			buildIconPreset('Focused (Icon)', ICONS.YELLOW_LIGHT, YELLOW),
